...
function InviteAcceptanceContent() {
  ...
  const handleGoogleLogin = () => {
    setStatus("loading");
    // Simulate accepting the invite via Google OAuth
    setTimeout(() => {
      if (inviteDetails) {
        login({
          name: "New User",
  ...
  return (
    ...
    >
      <div className="rounded-3xl border border-border/80 bg-card/80 p-8 shadow-lift backdrop-blur-2xl">
        ...
        <Button variant="outline" size="lg" onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2">
